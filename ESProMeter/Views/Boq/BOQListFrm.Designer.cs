...
namespace ESProMeter.Views.Boq
{
	partial class BOQListFrm
	{
		...
		private void InitializeComponent()
		{
			...
			this.dtgBOQList.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle6;
			...
			this.dtgBOQList.DefaultCellStyle = dataGridViewCellStyle7;
			...
			this.dtgBOQList.RowHeadersDefaultCellStyle = dataGridViewCellStyle8;
			...
			this.dtgBOQLine.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle9;
			...
			this.dtgBOQLine.DefaultCellStyle = dataGridViewCellStyle10;
